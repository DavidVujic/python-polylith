---
name: split-big-component
description: Split the big component (`components/<top_ns>/<BRICK_NAME>/`) into multiple focused components.
---

# Skill: split-big-component

## Goal
Split the big component (`components/<top_ns>/<BRICK_NAME>/`) into multiple focused components to improve maintainability, clarity, and reusability.
